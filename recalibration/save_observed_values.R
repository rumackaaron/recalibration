...
observed_df = read.csv(file.path(historical_dir,"observed_bins.csv"))
...
swgt.observed.values = map_join(df_to_val,s.retro.seasons,w.retro.models.weeks,g.epigroups,t.targets)
